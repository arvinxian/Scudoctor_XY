...
public class MainFragmentActivity extends FragmentActivity implements View.OnClickListener{
    ...
    private int[] bt_id={R.id.iv_menu_0,R.id.iv_menu_1,R.id.iv_menu_2,R.id.iv_menu_3,R.id.iv_menu_4};
    private int[] select_on={R.drawable.guide_home_on,R.drawable.guide_discover_on,R.drawable.guide_category_on,R.drawable.guide_cart_on,R.drawable.guide_account_on};
    private int[] select_off={R.drawable.guide_home_nm,R.drawable.guide_discover_nm,R.drawable.guide_category_nm,R.drawable.guide_cart_nm,R.drawable.guide_account_nm};
